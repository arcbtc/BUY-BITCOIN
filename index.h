const char MAIN_page[] PROGMEM = R"=====(
  ...
  <HTML><HEAD><TITLE>A Cypherpunk's Manifesto</TITLE>
  <STYLE type="text/css">
  BODY { color: #000000; background-color: #ffffff; .coltext: #800080; }
  </STYLE>
  </HEAD>
  <BODY>
  ...
  by <b class="coltext">Eric Hughes, 9 March 1993</b> <P>

  Privacy is necessary for an open society in the electronic age.
  Privacy is not secrecy.  A private matter is something one doesn't
  want the whole world to know, but a secret matter is something one
  doesn't want anybody to know. Privacy is the power to selectively
  reveal oneself to the world.   <P>
  ...
  the default is anonymity requires the cryptographic signature. <P>
  ...
  for strong privacy, but electronic technologies do. <P>
  ...
  a widely dispersed system can't be shut down.  <P>
  ...
  it the anonymous transactions systems that it makes possible.  <P>
  ...
  some may disagree with our goals. <P>

  The Cypherpunks are actively engaged in making the networks safer for
  privacy.  Let us proceed together apace. <P>

  Onward. <P>

  Eric Hughes, 9 March 1993<P>
<br></br>
<h1>For information about bitcoin specifically, connect to a network with internet and go here <a href="https://lopp.net/bitcoin.html">lopp.net/bitcoin.html</a></h1>
  </body>
  </html>
